...
ResDesk Calendar is a complicated scheduling service that allows for shift creation and 
a shft change process.
...
- run `brew install mongodb` to install mongodb from brew
  ...
  - create a local copy of the db by running `use res_desk_calendar_service`
...
API:
- this service runs on port 10013
- [docs](http://localhost:10013/docs/index.html)
